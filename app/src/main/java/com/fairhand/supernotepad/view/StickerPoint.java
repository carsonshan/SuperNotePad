...
/**
 * @author Phanton
 * @date 11/24/2018 - Saturday - 3:51 PM
 */
public class StickerPoint extends View {
    ...
    public StickerPoint(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    
    public StickerPoint(Context context, AttributeSet attrs, int defStyleAttr) {
