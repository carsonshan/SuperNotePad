...
public class SignUpActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void signUp() {
        // 调用验证码验证接口
        // 参数说明：国家代码，手机号码，验证码
        // 验证成功后，回调EventHandler的afterEvent方法(event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE)
        SMSSDK.submitVerificationCode("86", etMobNum.getText().toString(), etMobCode.getText().toString());
    }
    ...
    private void sendCode() {
        ...
        // 判断输入的手机号是否合法
            ...
            if (TextUtils.isEmpty(password)) {
                ...
                // 调用发送短信接口
                // 参数说明：国家代码，手机号码
                // 发送成功后，回调EventHandler的afterEvent方法(event == SMSSDK.EVENT_GET_VERIFICATION_CODE)
